...
export function generateAgentsMd(summary: ProjectSummary): string {
  return baseEngineContext('Codex', 'AGENTS.md', summary, 'Leia este arquivo antes de planejar ou editar.');
}

export function baseEngineContext(engineName: string, targetFile: string, summary: ProjectSummary, engineInstruction: string): string {
