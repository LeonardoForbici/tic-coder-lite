...
export interface AgentContextEnhancementInput {
  projectName: string;
  agentContext: string;
...
export async function enhanceAgentContext(client: OllamaClient, input: AgentContextEnhancementInput): Promise<string> {
...
export async function enhanceQuestions(client: OllamaClient, input: AgentContextEnhancementInput): Promise<string> {
